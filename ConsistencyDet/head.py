...
class DynamicHead(nn.Module):
    def __init__(self, cfg, roi_input_shape, distillation):
        super().__init__()
        # Build Consistency Function
        """
        self.cskip = func1(t)
        self.cout = func2(t)
        self.cin = func3(t)
        ...
        # Build heads.
        num_classes = cfg.MODEL.ConsistencyDet.NUM_CLASSES
        d_model = cfg.MODEL.ConsistencyDet.HIDDEN_DIM
        dim_feedforward = cfg.MODEL.ConsistencyDet.DIM_FEEDFORWARD
        nhead = cfg.MODEL.ConsistencyDet.NHEADS
        dropout = cfg.MODEL.ConsistencyDet.DROPOUT
        activation = cfg.MODEL.ConsistencyDet.ACTIVATION
        num_heads = cfg.MODEL.ConsistencyDet.NUM_HEADS
        rcnn_head = RCNNHead(cfg, d_model, num_classes, dim_feedforward, nhead, dropout, activation)
        self.head_series = _get_clones(rcnn_head, num_heads)
        self.num_heads = num_heads
        self.return_intermediate = cfg.MODEL.ConsistencyDet.DEEP_SUPERVISION
        ...
        if self.use_focal or self.use_fed_loss:
            prior_prob = cfg.MODEL.ConsistencyDet.PRIOR_PROB
...
class RCNNHead(nn.Module):
    ...
    def __init__(self, cfg, d_model, num_classes, dim_feedforward=2048, nhead=8, dropout=0.1, activation="relu",
        ...
        # cls.
        num_cls = cfg.MODEL.ConsistencyDet.NUM_CLS
        cls_module = list()
        ...
        # reg.
        num_reg = cfg.MODEL.ConsistencyDet.NUM_REG
        reg_module = list()
    ...
    def forward(self, features, bboxes, pro_features, pooler, time_emb):
        ...
        pred_bboxes = self.apply_deltas(bboxes_deltas.to('cuda'), bboxes.view(-1, 4).to('cuda'))
...
class DynamicConv(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        self.dim_dynamic = cfg.MODEL.ConsistencyDet.DIM_DYNAMIC
        self.num_dynamic = cfg.MODEL.ConsistencyDet.NUM_DYNAMIC
